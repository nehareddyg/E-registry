...
public class FrequencyOfSeizuresBeforeTreatmentCodeableConcept extends CodeableConceptDt{

/**
	 * 
	 */
	private static final long serialVersionUID = -3905589972338281405L;

public FrequencyOfSeizuresBeforeTreatmentCodeableConcept() {
		...
		this.setText("frequencyOfSeizuresBeforeTreatment");
		this.setId("8");
	}
